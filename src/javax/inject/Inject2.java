 ...
 * <h3>Qualifiers</h3>
 *
 * <p>A {@linkplain Qualifier2 qualifier} may annotate an injectable field
 ...
 * circular dependency by injecting {@link Provider2 Provider&lt;A>} or {@code
 * Provider<B>} instead of {@code A} or {@code B} respectively. Calling {@link
 * Provider2#get() get()} on the provider directly from the constructor or
 ...
 * one of the dependencies (using {@linkplain Singleton2 singleton scope}, for
 * example) may also enable a valid circular relationship.
 *
 * @see Qualifier2 @Qualifier
 * @see Provider2
 */
